...
async def list_sectors(
    ...
    return list(await service.list_sectors(db, scope if scope is not None else clinic_id))
...
async def get_sector(
    ...
    return await service.get_sector(db, sector_id, clinic_scope(current))
...
@router.post(
    ...
    dependencies=[Depends(requires("sectors", "sectors"))],
)
...
async def update_sector(
    ...
    return await service.update(db, sector_id, payload, clinic_scope(current))
