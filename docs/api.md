...
| **cases**         | `GET /cases` · `POST /cases` · `GET /cases/{id}` · `PATCH /cases/{id}` · `GET /cases/{id}/activities` · `POST /cases/{id}/activities` |
...
| **reports**       | `GET /reports/dashboard` · `GET /reports/compliance` |
